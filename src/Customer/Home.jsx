  ...
  <Navbar />
        ...
        <header className=" owncolor py-5">
            <div className="container px-4 px-lg-5 my-5">
                <div className="text-center text-white">
                    ...
                    <p className="lead fw-bold  text-white-90 mb-0">We will deliver 😊</p>
                </div>
            </div>
        </header>
        ...
        <section className="py-5">
            <div className="container px-4 px-lg-5 mt-5">
                ...
                {homeItems.map((val,i)=>{
                    return <HomeItems cart={cart} setCart={setCart} values={val} key={i}/>
                })}
                </div>
            </div>
        </section>
        <footer className="py-5 bg-dark">
            <div className="container"><p className="m-0 text-center text-white">Copyright &copy; Thin Pandam 2024</p></div>
        </footer>
  </>
}
