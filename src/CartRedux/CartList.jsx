...
export const CartList=createSlice({
    ...
    reducers:{
        handleAdd:(state,action)=>{
            ...
            state[index].Cart==="Add to Cart"?state[index].Cart="Remove From Cart":state[index].Cart="Add to Cart"
...
export const {handleAdd,handleDelete,handleCartAdd,handleCartRemove} = CartList.actions
